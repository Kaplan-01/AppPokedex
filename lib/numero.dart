...
void main() => runApp(PantallaNumeros());
...
class _buscaNumero extends StatefulWidget {
  @override
  _myHomePageState createState() => new _myHomePageState();
}

class _myHomePageState extends State<_buscaNumero> {
  ...
  _sinohay() {
    int tryo = pokeHub.pokemon
        .where((poke) =>
        poke.num.toString().toLowerCase().contains(_search.text.toLowerCase())).length;
    if (tryo == 0) {
    ...
    return new Scaffold(
        ...
        body: pokeHub == null
          ...
          return GridView.count(
            ...
            children: pokeHub.pokemon.where((poke)=>poke.num.toLowerCase().contains(_search.text.toLowerCase()))
                .map(
                  (poke) => Padding(
