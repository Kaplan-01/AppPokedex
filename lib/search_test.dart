...
class MyApps extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      ...
      home: homePagess(this.tipos),
    );
  }
}
class homePagess extends StatefulWidget {
  homePagess(this.tipos);
  String tipos;
  @override
  _myHomePageState createState() => new _myHomePageState(this.tipos);
}
class _myHomePageState extends State<homePagess> {
  _myHomePageState(this.tipos);
  String tipos;
    ...
    return new Scaffold(
        ...
        body: pokeHub == null
          ...
          return GridView.count(
              ...
              children:
              pokeHub.pokemon.where((poke) =>poke.type.toList().toList().toString().toLowerCase().contains(this.tipos.toLowerCase()))
                  .map(
                    (poke) => Padding(
