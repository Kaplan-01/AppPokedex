...
void main() => runApp(PantallaTipos());

class PantallaTipos extends StatelessWidget {
  @override
...
class _buscaTipo extends StatefulWidget {
  @override
  _myHomePageState createState() => new _myHomePageState();
}

class _myHomePageState extends State<_buscaTipo> {
